...
wget http://192.168.12.223/ks/ali/2.3.7/hwqc.inspur.v2.3.7.tar.bz2
...
tar -jxvf hwqc.inspur.v2.3.7.tar.bz2

cd aliwork
cp -rf ../hwqc.git/hwqc usr/alisys/dragoon/libexec/
...
sleep 1
/home/tops/bin/python /usr/alisys/dragoon/libexec/hwqc/lib/tools/hwinfo.py -pt all > 1.txt
EOF
