#!/bin/bash
###############################
#Name:SUT_001_SIT_CPUSTRESS_TEST_SUSE
#Author:yanshuo
#Revision:
#Version:V001
#Date:2017-11-17
#Tracelist:V001-->First Version
#Function: CPU stress test under SUSE
#Parameter_1: total test seconds
#Parameter_2:platform(purley/grantley)
#Usage:sh SUT_001_SIT_CPUSTRESS_TEST_SUSE_V001.sh Parameter_1 Parameter_2
#Example:sh SUT_001_SIT_CPUSTRESS_TEST_SUSE_V001.sh 3600 purley
###############################

[ ! -d log ] && mkdir log
#create log file
time_start=`date +%Y%m%d%H%M%S`
log_dir_name="${time_start}_SIT_CPUSTRESS_TEST_SUSE"
log_file_name="${time_start}_SIT_CPUSTRESS_TEST_SUSE.log"
current_path=`pwd`
