#!/bin/bash
###############################
#Name:SUT_001_SIT_MEMSTRESS_TEST_DEBIAN
#Author:yanshuo
#Revision:
#Version:V001
#Date:2017-12-19
#Tracelist:V001-->First Version
#Function: memory test under  DEBIAN
#Parameter_1:total test seconds
#Usage:bash SUT_001_SIT_MEMSTRESS_TEST_DEBIAN_V001.sh Parameter_1
#Example:bash SUT_001_SIT_MEMSTRESS_TEST_DEBIAN_V001.sh 3600
#Description: to start memtester under debian  and after some time to kill the process
###############################
...
log_dir_name="${time_start}_SIT_MEMSTRESS_TEST_DEBIAN"
log_file_name="${time_start}_SIT_MEMSTRESS_TEST_DEBIAN.log"
current_path=`pwd`
...
echo -e "Begin memtester test! Start time:\033[32m${time_start} \033[0m"
#check input!
if [ $# != 1 ];then
...
echo -e "Finish memtester test! End time:\033[32m${time_end} \033[0m"
