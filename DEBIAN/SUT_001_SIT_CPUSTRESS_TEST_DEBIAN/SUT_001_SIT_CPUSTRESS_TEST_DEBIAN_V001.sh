#!/bin/bash
###############################
#Name:SUT_001_SIT_CPUSTRESS_TEST_DEBIAN
#Author:yanshuo
#Revision:
#Version:V001
#Date:2017-12-19
#Tracelist:V001-->First Version
#Function: CPU stress test under debian
#Parameter_1: total test seconds
#Usage:bash SUT_001_SIT_CPUSTRESS_TEST_DEBIAN_V001.sh Parameter_1
#Example:bash SUT_001_SIT_CPUSTRESS_TEST_DEBIAN_V001.sh 3600
###############################

[ ! -d log ] && mkdir log
#create log file
time_start=`date +%Y%m%d%H%M%S`
log_file_name="${time_start}_SIT_CPUSTRESS_TEST_DEBIAN.log"
current_path=`pwd`
log_path="${current_path}/log/${log_file_name}"
touch ${log_path}
#echo start time
echo -e "Begin to test!Start time:\033[32m${time_start}\033[0m"
# write  start time
...
#echo end time
echo -e "End test!End time:\033[32m${time_end}\033[0m"
