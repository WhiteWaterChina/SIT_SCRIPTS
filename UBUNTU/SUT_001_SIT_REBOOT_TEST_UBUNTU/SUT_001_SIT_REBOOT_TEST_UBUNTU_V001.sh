#!/bin/bash
##############################
#Name:SUT_001_SIT_REBOOT_TEST_UBUNTU
#Author:yanshuo
#Revision:
#Version:A01
#Date:2017-11-28
...
#Usage:bash SUT_001_SIT_REBOOT_TEST_UBUNTU_V001.sh Parameter_1 Parameter_2 Parameter_3　Parameter_4
#Example:
#1.reboot  bash SUT_001_SIT_REBOOT_TEST_UBUNTU_V001.sh reboot 43200 500 40
#2.dc/ac   bash SUT_001_SIT_REBOOT_TEST_UBUNTU_V001.sh dc 43200 500 40
###############################
...
log_dir_name="${time_start}_SIT_REBOOT_TEST_UBUNTU"
log_file_name="${time_start}_SIT_REBOOT_TEST_UBUNTU.log"
current_path=`pwd`
